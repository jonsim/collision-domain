...
SpawnScreen::SpawnScreen( Ogre::Camera* cam )
{
    ...
    mViewCar[CAR_BANGER] = (Car*) new SimpleCoupeCar(GameCore::mPhysicsCore->getUniqueEntityID(), NO_TEAM);
    mViewCar[CAR_SMALL] = (Car*) new SmallCar(GameCore::mPhysicsCore->getUniqueEntityID(), NO_TEAM);
    mViewCar[CAR_TRUCK] = (Car*) new TruckCar(GameCore::mPhysicsCore->getUniqueEntityID(), NO_TEAM);
