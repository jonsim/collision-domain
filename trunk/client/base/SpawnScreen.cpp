...
SpawnScreen::SpawnScreen( Ogre::Camera* cam )
{
    ...
    mViewCar[CAR_BANGER] = (Car*) new SimpleCoupeCar(GameCore::mPhysicsCore->getUniqueEntityID(), SKIN_DEFAULT);
    mViewCar[CAR_SMALL] = (Car*) new SmallCar(GameCore::mPhysicsCore->getUniqueEntityID(), SKIN_DEFAULT);
    mViewCar[CAR_TRUCK] = (Car*) new TruckCar(GameCore::mPhysicsCore->getUniqueEntityID(), SKIN_DEFAULT);
